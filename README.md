...
1. Clone the repository:
    ```bash
    git clone https://github.com/saigopalrathod/FlappyBirdAI.git
    cd FlappyBirdAI
    ```
...
Sai Gopal Rathod is an AI/ML Engineer with over 4 years of experience building applied AI systems, RAG pipelines, and distributed data architectures. With a professional background spanning roles at Amazon and Altice USA, he specializes in Python, Flask, and neural network implementations.
